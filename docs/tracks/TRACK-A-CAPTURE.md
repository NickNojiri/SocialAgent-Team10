...
| 33 | TikTok + YouTube Shorts capture | Nice | 100 | 4 |
...
**#33 TikTok + YouTube Shorts capture (100)**
...
**You receive from Nick** — Phase 2: capture moves to a background job (#27). Your fetch
