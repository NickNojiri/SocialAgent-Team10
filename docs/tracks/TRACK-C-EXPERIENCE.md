...
| 32 | Distance + map on spot cards | Nice | 40 | 2 |
...
| 31 | Catalog browsing v2 | Nice | 60 | 4 |
| 33 | Accessibility pass | Nice | 50 | 4 |
...
- [ ] Expose median and p95 to Nick's operations dashboard (#25).
...
**#32 Distance + map on spot cards (40)**
...
(#25) can chart them rather than inventing its own.
...
**From Nick** — **Phase 2**: non-blocking capture (#23) with a live stage line; your
