...
- **Tokens never expire** and cannot be revoked individually — whoever copies one keeps
  access until the whole signing key is rotated. That's your #30.
- No dependency scanning, no secret scanning in CI. That's your #31.
- Nothing logs or alerts on refused authorizations, rate-limit hits, or blocked hosts —
  we can't see an attack even in hindsight. That's your #32.
...
| 30 | Authentication & session hardening ★ | Should | 100 | 2 |
| 13 | Threat model & security review | Must | 60 | 3 |
| 31 | Dependency & supply-chain scanning | Should | 60 | 3 |
| 32 | Abuse & intrusion monitoring ★ | Should | 100 | 4 |
...
**#30 Authentication & session hardening ★ (100)**
...
**#31 Dependency & supply-chain scanning (60)**
...
**#32 Abuse & intrusion monitoring ★ (100)**
...
- [ ] Alert on spikes; add a panel to the operations dashboard (Nick's #29).
